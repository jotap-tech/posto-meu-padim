      ...
      <div className="bg-white border border-gray-200 rounded-xl p-4 mb-6">
        <div className="relative max-w-md">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-500"
          />
        </div>
      </div>
            ...
            >
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  required
                  className="w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-gray-700 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                >
            ...
            <div className="p-6">
              ...
              <div className="flex justify-end gap-3 mt-6">
                ...
                <button
                  ...
                  className="rounded-lg bg-red-600 px-4 py-2.5 text-sm font-medium text-white hover:bg-red-700 transition"
                >
                  Excluir produto
                </button>
              </div>
